...
public class MyDatabase {
    ...
    public String updateTask(Task updatedTask) throws SQLException {
        String sql = "UPDATE Tasks SET Name=?, Description=?, Priority=?, OwnerUserName=?, Start=?, End=?, Phase=? WHERE Id=?";
        PreparedStatement statement = connection.prepareStatement(sql);
        statement.setString(1, updatedTask.getTaskName());
        statement.setString(2,updatedTask.getDescription());
        statement.setString(3, String.valueOf(updatedTask.getPriority().ordinal() + 1));
        ...
        statement.setString(7, String.valueOf(updatedTask.getPhase().ordinal() + 1));
        statement.setString(8, String.valueOf(updatedTask.getTaskId()));
    ...
    public void getTasks(ArrayList<Task> tasks, ArrayList<User> userList) throws SQLException {
        ...
        while (resultSet.next()){
            ...
            newTask.setPhase(resultSet.getString("Phase"));
    ...
    public void createTask(Task task) throws SQLException {
        String sql = "INSERT INTO Tasks (Id, Name, Description, Priority, OwnerUserName, Start, End,Phase) VALUES (?,?,?,?,?,?,?,?)";
        PreparedStatement statement = connection.prepareStatement(sql);
        statement.setString(1, String.valueOf(task.getTaskId()));
        statement.setString(2, task.getTaskName());
        statement.setString(3,task.getDescription());
        statement.setString(4, String.valueOf(task.getPriority().ordinal() + 1));
        ...
        statement.setString(8, String.valueOf(task.getPhase().ordinal() + 1));
        statement.executeUpdate();
    }
